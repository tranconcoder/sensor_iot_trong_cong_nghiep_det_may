...
export const getEsp32CamSecurityGateSourcePath = () => {
    const directoryPath = path.join(__dirname, `../assets/videos/esp32_security_gate_cam/`);
...
export const [FRAMESIZE_HEIGHT, FRAMESIZE_WIDTH] = FRAMESIZE.split("x").map((x) => Number(x));
...
export const DRAWTEXT_FONTPATH = path.join(__dirname, "../assets/fonts/CaskaydiaCoveNerdFontMono-Regular.ttf");
