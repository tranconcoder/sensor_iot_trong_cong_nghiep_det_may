...
export const handleError = (error) => console.log(`Encoding Error: ${error.message}`);
export const convertObjectConfigToString = (config, symbol, separateSymbol) => {
    let result = "";
